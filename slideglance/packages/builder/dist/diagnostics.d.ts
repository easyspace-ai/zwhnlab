export type DiagnosticCode = "IMAGE_MEASURE_FAILED" | "IMAGE_NOT_PREFETCHED" | "AUTOFIT_OVERFLOW" | "SCALE_BELOW_THRESHOLD" | "MASTER_PPTX_PARSE_FAILED" | "INVALID_HREF_SCHEME" | "INVALID_IMAGE_SRC" | "TEMPLATE_EXPANSION_LIMIT" | "MASTER_PPTX_SIZE_LIMIT" | "TEMPLATES_NOT_AT_ROOT" | "INVALID_NUMBER_TYPE" | "DUPLICATE_NODE_ID" | "UNKNOWN_CONNECTOR_ENDPOINT" | "INVALID_CONNECTOR_SELF_REF" | "CONNECTOR_UNKNOWN_SHAPE_IDX" | "RAW_LT_GT_IN_ATTR" | "OUT_OF_PAGE" | "OUT_OF_PARENT" | "NEGATIVE_DIM" | "ZERO_DIM" | "TEXT_OVERFLOW_V" | "TEXT_OVERFLOW_H" | "TEXT_WRAP_TO_1CH" | "LINE_OVER_PARENT" | "IMAGE_MISSING" | "BASELINE_MIX_IN_ROW" | "INFLATED_LINE_HEIGHT_IN_ROW" | "ANCHOR_INCONSISTENT" | "OVERLAP_LAYER" | "LOW_CONTRAST" | "UNUSED_STYLE" | "UNUSED_TEMPLATE" | "HARDCODED_COLOR" | "INCONSISTENT_FONT" | "MASTER_COLLISION" | "IMG_NO_ALT" | "READING_ORDER_AMBIGUOUS" | "ICON_NO_LABEL" | "TINY_FONT" | "LARGE_IMAGE_INLINED" | "EXCESS_NODES" | "SLIDE_FONT_COUNT";
...
export declare class DiagnosticCollector {
    ...
    add(code: DiagnosticCode, message: string, sourcePos?: DiagnosticSourcePos): void;
