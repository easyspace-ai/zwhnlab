...
import { type ResolvedDefaultTextStyle } from "./defaultTextStyle.ts";
...
export declare function createBuildContext(options?: CreateBuildContextOptions): BuildContext;
