 ...
 */
import { buildReferenceModel } from "./walkRegistry.js";
import { escapeHtml, highlightXml, attrTable, childrenTable, usedByList, } from "./htmlTemplates.js";
const REPO_BLOB = "https://github.com/SlideGlance/slideglance/blob/main/packages/builder";
...
export function renderElementPage(node, model) {
    const tag = node.tag;
...
function renderSidebar(currentTag, model) {
    const link = (tag) => {
