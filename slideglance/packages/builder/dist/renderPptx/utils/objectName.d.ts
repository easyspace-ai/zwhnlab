 ...
 */
export declare function builderObjectName(node: {
    __nodeId?: number;
    id?: string;
    /**
 ...
 */
export declare function renderObjectName(node: {
    __nodeId?: number;
    id?: string;
}, ctx: RenderContext): string | undefined;
//# sourceMappingURL=objectName.d.ts.map