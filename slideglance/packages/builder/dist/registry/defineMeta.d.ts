...
export interface CompiledMetaDefinition extends Required<Pick<MetaSpec, "tag" | "description" | "contentModel">> {
    attributes: Record<string, AttributeSpec>;
    openAttributes: boolean;
    allowedParents: readonly string[];
    root: boolean;
...
export declare function defineMeta(spec: MetaSpec): CompiledMetaDefinition;
export {};
//# sourceMappingURL=defineMeta.d.ts.map