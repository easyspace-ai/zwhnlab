...
exports.PptxDocument = PptxDocument;
 ...
 * @returns {any}
 */
function convertPptxToPng(bytes, slides, width, height, fonts) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        const ptr0 = passArray8ToWasm0(bytes, wasm.__wbindgen_export);
        const len0 = WASM_VECTOR_LEN;
...
exports.convertPptxToPng = convertPptxToPng;
 ...
 * @returns {any}
 */
function convertPptxToSvg(bytes, slides, fonts) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        const ptr0 = passArray8ToWasm0(bytes, wasm.__wbindgen_export);
        const len0 = WASM_VECTOR_LEN;
...
exports.convertPptxToSvg = convertPptxToSvg;
...
exports.parsePptxData = parsePptxData;
 ...
 * @returns {Uint8Array}
 */
function svgToPng(svg, width, height, fonts) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
...
const wasmPath = `${__dirname}/slideglance_wasm_bg.wasm`;
