...
export { parseAspect, prepareSvg, rewriteMediaRefs, extractAndStripFontStyle, extractFontStyleCss, } from "./svg-utils.js";
export type { TextRenderMode, FontFallback, SlideSvg, MediaBlob, RenderedSlide, SlideController, SlideMeta, } from "./types.js";
export { t, setLocale, getActiveLocale, getDetectedLocale, detectLocale, subscribeLocale, resetLocaleCache, SUPPORTED_LOCALES, } from "./ui/i18n.js";
